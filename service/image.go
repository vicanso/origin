...
// Optim image optim
func (srv *ImageSrv) optim(params *ImageOptimParams) (data []byte, err error) {
...
func (srv *ImageSrv) GetImageFromBucket(bucket, filename string, params ImageOptimParams) (data []byte, header http.Header, err error) {
